...
let EC2_RUN_INSTANCE_CONCURRENCY = Number(process.env["EC2_RUN_INSTANCE_CONCURRENCY"]);
if (isNaN(EC2_RUN_INSTANCE_CONCURRENCY) || EC2_RUN_INSTANCE_CONCURRENCY < 0) {
  EC2_RUN_INSTANCE_CONCURRENCY = 2;
}
